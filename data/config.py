...
paneles = dataset_base.copy({
    'name': 'paneles',

    'train_images': 'datasets/panelsV2_2/train',
    'train_info':   'datasets/panelsV2_2/train/_annotations.coco.json',

    'valid_images': 'datasets/panelsV2_2/valid',
    'valid_info':   'datasets/panelsV2_2/valid/_annotations.coco.json',

    'has_gt': True,
    'class_names': ('crack','defect','fingers','fingers between cracks','silicon', 'tire')
})
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': paneles,
    'num_classes': len(paneles.class_names) + 1,
